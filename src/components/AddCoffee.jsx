...
const AddCoffee = () => {
    ...
    const handleAddCoffee = event =>{
        ...
        fetch('https://coffee-store-server-6fzbfnrrd-md-masud-ranas-projects.vercel.app/coffee', {
            method: 'POST',
            headers: {
      ...
      <form onSubmit={handleAddCoffee} className="space-y-8">
        ...
        <div className="md:flex">
          ...
          <div className="form-control md:w-1/2 ml-4">
            ...
            <label className="input-group">
              <input type="text" name="quantity" placeholder="Enter coffee Available Quantity"
                className="input input-bordered w-full" />
            </label>
          </div>
        </div>
        ...
        <input type="submit" value="Add Coffee" className="btn btn-block bg-[#D2B48C] normal-case" />
      </form>
    </div>
  );
};
